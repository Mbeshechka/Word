...
public class KeyBoard {
    ...
    private  float keyboardWidth, keyboardHeight; // ширина и высота всей клавиатуры
    ...
    private  int enterTextLength; // длина вводимого текста
    ...
    private Music kn4 = Gdx.audio.newMusic(Gdx.files.internal("kn4.mp3"));// список всех кноп
    ...
    public KeyBoard(BitmapFont font, float scrWidth, float scrHeight, int enterTextLength){
    ...
    private void setText(int i){
        ...
        switch (letters.charAt(i)) {
            ...
            default: // ввод символов
                ...
                if(text.length()< enterTextLength && "QWERTYUIOPASDFGHJKLZXCVBNMqwertyuiopasdfghjklzxcvbnm".contains(String.valueOf(letters.charAt(i)))) text += letters.charAt(i);
    ...
    public String getEnglishText() {
        ...
        String io = "QWERTYUIOPASDFGHJKLZXCVBNMqwertyuiopasdfghjklzxcvbnm";
        for (int i = 0; i < text.length(); i++) {
            String k = String.valueOf(text.charAt(i-deli));
            if (!io.contains(k)){
                text = text.replace(String.valueOf(text.charAt(i-deli)),"");
                deli++;
            }
